    ...
    <>
      <main className="min-h-screen overflow-hidden bg-primary flex flex-col items-center justify-between relative">
        <header className="h-20 flex items-center justify-center  w-full">
          <h1 className="text-shadow-lg underline decoration-shine underline-offset-8 text-shadow-black text-white font-bold uppercase font-Girassol tracking-widest text-3xl">
            invitation
          </h1>
        </header>
        <img
        ...
        />
        <div className="text-white border-4 md:w-[80%] border-double border-shine rounded-lg mx-5 md:text-lg p-5 flex flex-col">
          <p className="z-1">
          ...
          <img
            src={vin}
            alt="VIN Logo"
            className="absolute opacity-50 right-[50%] left-[50%] transform -translate-x-1/2"
          />
          <p className="z-1">
